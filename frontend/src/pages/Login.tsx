...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ── Painel esquerdo — identidade Farol ───────────────────────── */}
      <div
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-xs pt-2" style={{ color: "#475569" }}>
            © {new Date().getFullYear()} Fortes Bezerra Tecnologia · Farol v{__APP_VERSION__}
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-[600px]">
          ...
          <Card className="w-full shadow-md border-0">
            <CardHeader className="flex flex-col items-center gap-3 space-y-0 pt-14 pb-8">
              <CardTitle className="text-5xl font-bold">Acesse sua conta</CardTitle>
