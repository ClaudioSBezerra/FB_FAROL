    ...
    <div className="min-h-screen bg-slate-50 text-base">
      ...
      <div className="bg-white border-b-2 border-slate-300 px-4 py-3 sticky top-0 z-10 shadow-sm">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          {/* Por RCA / Por Indústria — só no escopo Supervisor. V05 ("Por
              Indústria", rótulo renomeado de "Por Fornecedor" em 28/08/2026 a
              pedido do Heverton) só traz fornecedores cadastrados como
              indústria — ver restrição em FarolV2PublicCardsHandler. */}
          {scope === 'sup' && (
            <div className="inline-flex rounded-lg border-2 border-slate-300 overflow-hidden bg-white shadow-sm">
              <button
