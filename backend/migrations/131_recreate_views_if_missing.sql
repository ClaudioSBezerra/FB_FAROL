-- Migration 131: recria vw_obj_rca_fornecedor e vw_obj_supervisor se não existirem.
-- Necessário porque a migration 127 (ao ser re-executada após 128-130) apagou as views
-- sem recriá-las, e o runner já marcou 128-130 como aplicadas.
